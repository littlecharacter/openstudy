...
public class IndexTree {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("原始数组：" + Arrays.toString(tree.nums));
        System.out.println("树型数组：" + Arrays.toString(tree.tree));
        System.out.println("API：[1,3]累加和=" + tree.sum(3));
        System.out.println("--------------------------------------");
        tree.add(2, 2);
        System.out.println("API：2位置加2");
        System.out.println("原始数组：" + Arrays.toString(tree.nums));
        System.out.println("树型数组：" + Arrays.toString(tree.tree));
        System.out.println("API：[1,3]累加和=" + tree.sum(3));
    }
