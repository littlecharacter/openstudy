package com.lc.structure.tree.binary.ss;
...
public class HuffmanTree {
    // 根据文章str, 生成词频统计表
    public HashMap<Character, Integer> countMap(String str) {
    ...
    // F 00101
    // G 00100
    public HashMap<Character, String> huffmanForm(HashMap<Character, Integer> countMap) {
    ...
    public static void main(String[] args) {
        ...
        map.put('F', 5);
        map.put('G', 3);
        HashMap<Character, String> huffmanForm = huffmanTree.huffmanForm(map);
        ...
        for (int i = 0; i < testTime; i++) {
            ...
            HashMap<Character, Integer> counts = huffmanTree.countMap(test);
            HashMap<Character, String> form = huffmanTree.huffmanForm(counts);
            String encode = huffmanTree.huffmanEncode(test, form);
            String decode = huffmanTree.huffmanDecode(encode, form);
