...
public class SegmentTree {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(tree.lazy));
        // 打印 1~6 范围上的累加和
        System.out.println("[1,6]范围上的累加：" + tree.query(1,6));
        // 将 1~6 范围上，每个位置的值都加 3
        tree.add(1, 6, 3);
        System.out.println("[1,6]范围上每个位置都加3");
        System.out.println(Arrays.toString(tree.arr));
        System.out.println(Arrays.toString(tree.sum));
        System.out.println(Arrays.toString(tree.lazy));
        System.out.println("[1,6]范围上的累加：" + tree.query(1,6));
        ...
        tree.update(1, 6, 3);
        System.out.println("[1,6]范围上每个位置都设置成3");
        System.out.println(Arrays.toString(tree.arr));
        System.out.println(Arrays.toString(tree.sum));
        System.out.println(Arrays.toString(tree.lazy));
        System.out.println("[1,6]范围上的累加：" + tree.query(1,6));
